...
{      
	$.ajax({
		...
		dataType: "html",
			...
			id: editableGrid.getValueAt(rowIndex, 0), //hard coded the value of the ID in the Grid
...
{ 
	this.editableGrid = new EditableGrid("diesel_use", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("loaddata.php?db_tablename=diesel_use");
};
...
DatabaseGrid.prototype.addRow = function(id) 
{
  var self = this;
		...
		data: {
			tablename       : self.editableGrid.name,
			date 		    : $("#date").val(),
			gallons_used    : $("#gallons_used").val(),
			person		    : $("#person").val(),
			equipment	    : $("#equipment").val(),
			equipment_hours : $("#equipment_hours").val()
		},
		success: function (response) 
		{ 
			if (response == "ok" ) {
